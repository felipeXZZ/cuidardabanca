...
const LEVEL_CONFIG = {
  ...
  medium: {
    bar: 'bg-[#F59E0B]',
    track: 'bg-[#FEF3C7] dark:bg-[#F59E0B]/10',
    color: '#D97706',
    bgLight: '#FFFBEB', bgDark: '#1E293B',
    borderLight: '#FDE68A', borderDark: '#854d0e',
    textLight: '#92400E', textDark: '#FBBF24',
  },
  high: {
    bar: 'bg-[#EA580C]',
    track: 'bg-[#FFF7ED] dark:bg-[#EA580C]/10',
    color: '#EA580C',
    bgLight: '#FFF7ED', bgDark: '#1E293B',
    borderLight: '#FED7AA', borderDark: '#9A3412',
    textLight: '#9A3412', textDark: '#FB923C',
  },
  critical: {
    bar: 'bg-[#DC2626]',
    track: 'bg-[#FEE2E2] dark:bg-[#DC2626]/10',
    color: '#DC2626',
    bgLight: '#FEF2F2', bgDark: '#1E293B',
